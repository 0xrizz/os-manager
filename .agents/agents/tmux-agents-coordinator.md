...
- **Cross-Harness Skill Synchronization**: Maintain exact bidirectional synchronization between `.agents/skills/` and agent harnesses via `./scripts/sync_agent_skills.sh`.

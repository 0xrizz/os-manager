...
- **Multi-Agent Skill Synchronization**: Re-link and synchronize cross-agent skills between `.agents/skills/` and downstream agent harnesses -> `./scripts/sync_agent_skills.sh`.

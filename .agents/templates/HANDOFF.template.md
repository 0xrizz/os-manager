...
4. **Step 4 - Mandatory Cleanup (Rule 2)**: Once all session tasks are complete and verified, **refresh/clear** `.agents/temp/HANDOFF.md` (truncate to empty file without deleting the file itself).
